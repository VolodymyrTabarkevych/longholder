...
class SubtractPercentUseCase @Inject constructor(
    private val calcRepository: ICalcRepository,
    private val errorHandler: IErrorHandler
) : BaseUseCase<SubtractPercentUseCase.Params, String>() {

    override suspend fun run(params: Params): Resource<String> {
        return calcRepository.subtractPercent(percent = params.percent, number = params.number)
